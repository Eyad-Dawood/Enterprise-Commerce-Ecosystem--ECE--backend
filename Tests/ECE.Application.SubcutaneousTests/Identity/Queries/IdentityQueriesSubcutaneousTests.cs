namespace ECE.Application.SubcutaneousTests.Identity.Queries;

using FluentAssertions;
using Microsoft.Extensions.Logging.Abstractions;
using ECE.Application.Features.Identity.Queries.GenerateTokens;
using ECE.Application.Features.Identity.Queries.GetUserById;
using ECE.Application.Features.Identity.Queries.RefreshTokens;
using ECE.Application.SubcutaneousTests.Common;
using ECE.Application.SubcutaneousTests.Identity.TestDoubles;
using ECE.Domain.Identity;
...
public class IdentityQueriesSubcutaneousTests
{
    ...
    {
        // Arrange
        using var context = CommonTestsFactory.CreateDbContext();
        var identityService = new FakeIdentityService();
        var tokenProvider = new FakeTokenProvider();
        var userId = "user-1";
