namespace ECE.Application.SubcutaneousTests.Identity.Commands;

using FluentAssertions;
using Microsoft.Extensions.Logging.Abstractions;
using ECE.Application.Features.Identity.Commands.ChangePassword;
using ECE.Application.Features.Identity.Commands.ConfirmEmail;
using ECE.Application.Features.Identity.Commands.ResetPassowrd;
using ECE.Application.Features.Identity.Commands.SendEmailConfirmation;
using ECE.Application.Features.Identity.Commands.SendResetPassword;
using ECE.Application.SubcutaneousTests.Identity.TestDoubles;
using Xunit;
